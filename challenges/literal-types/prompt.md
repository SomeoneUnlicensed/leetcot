...
JavaScript, like most programming languages has a concept of [primitive data types](https://leetcot.ru/challenge/primitive-data-types). Primitive data types are things like `string`, `number` and `boolean`.
