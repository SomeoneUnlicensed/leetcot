...
Generics are an incredibly powerful tool in TypeScript. In a [previous challenge](https://leetcot.ru/challenge/generic-type-arguments) where generic type arguments were introduced, we compared them to function arguments _but for types_.
