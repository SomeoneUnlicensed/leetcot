...
1. Use [indexed types](https://leetcot.ru/challenge/indexed-types).
1. The error you'll see is because of a missing [generic constraint](https://leetcot.ru/challenge/generic-type-constraints).
