...
Have we said thank you, yet, for taking these ЛитКот challenges? Well... THANK YOU!
...
| ----------------- | ------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| variables         | `const`, `let`, function arguments                            | [type aliases](https://leetcot.ru/challenge/type-aliases), [default generic arguments](https://leetcot.ru/challenge/default-generic-arguments) |
...
Later, you're going to learn about ways to then do more operations on types. We're going to be extracting keys of objects <!-- todo [keys of objects](https://leetcot.ru/challenge/object-keys)-->, and creating new types for return types <!-- todo [return types](https://leetcot.ru/challenge/return-types) --> and parameters <!-- todo [parameters](https://leetcot.ru/challenge/parameters) --> of functions.
