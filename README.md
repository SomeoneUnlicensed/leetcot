...
Деплой — руками, с доверенной машины с реальным сетевым доступом до сервера
(не через CI: автогенерация/перезапись `.env` через пайплайн — намеренно
отклонённый вариант, слишком легко случайно переписать боевые секреты без
глаз человека на это).
