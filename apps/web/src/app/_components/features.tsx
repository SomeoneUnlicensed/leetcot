        ...
        <div className="flex flex-col items-center justify-center gap-16">
          <div className="mt-1 flex flex-col gap-3 px-4 text-center sm:px-0">
            ...
            <h1 className="text-4xl font-bold">
              <Balancer>Что есть в ЛитКот?</Balancer>
            </h1>
            <p className="text-black/60 dark:text-white/50">
              <Balancer>Всё, что нужно, чтобы стать грозой программирования</Balancer>
            </p>
          </div>
          <div className="relative z-10 grid w-full gap-4 md:grid-cols-2 lg:gap-8 [&>*:nth-child(3)]:hidden md:[&>*:nth-child(3)]:block">
            <ImageCard
              ...
              description="Решайте интерактивные задачи, чтобы укрепить понимание языка и продвинутых возможностей"
              ...
              title="Задачи на кодинг"
            />
            <CollaborativeEnvironmentCard
              description="Разработчики могут делиться решениями и участвовать в обсуждениях через комментарии"
              bgClass="md:bg-gradient-to-bl"
              title="Командная среда"
            />
            <ChallengeCreationCard
              step1img1Class={clsx(
              ...
              description="Создавайте собственные задачи, чтобы делиться ими с сообществом ЛитКот"
            ...
            />
            <CuratedTracksCard
              description="Треки — это подборки задач по различным темам и уровням сложности для развития навыков."
