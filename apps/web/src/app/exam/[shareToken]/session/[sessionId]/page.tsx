      ...
      >
        ...
        {currentQuestion.type === 'CODE_TASK' ? (
          <div className="mb-8 overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950">
            <PracticeWorkspace
              left={
                <Card className="flex h-full flex-col justify-between rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6 shadow-xl backdrop-blur-md">
                  <div>
                    ...
                    {currentQuestion.functionName ? (
                      <div className="mt-6 space-y-1.5 rounded-xl border border-zinc-800/80 bg-zinc-950/60 p-4 text-xs leading-relaxed text-zinc-400">
                        ...
                        <p>
                          ...
                          <code className="font-mono text-neutral-200">return</code>. Остальное
              ...
              right={
                <Card className="relative flex h-full min-h-[580px] flex-col gap-0 overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950 shadow-xl backdrop-blur-md">
                  {/* Header Settings Bar */}
