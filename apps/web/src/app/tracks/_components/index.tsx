      ...
      <div className="flex flex-col gap-5 pb-8 md:gap-10 md:py-5">
        ...
        <div className="container">
          ...
          <p className="max-w-[69ch] text-lg leading-10 text-neutral-600 sm:px-8 md:px-0 dark:text-white/50">
            ЛитКот предлагает подборку разнообразных задач по программированию, сгруппированных в
            различные треки, предлагая динамичный путь обучения для повышения квалификации
            разработчиков.
          </p>
        </div>
        <TrackGrid />
