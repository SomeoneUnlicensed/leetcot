...
`}
  ...
  return (
    <nav
      className={`bg-background/[0.52] supports-[backdrop-filter]:bg-background/[0.38] sticky top-0 z-40 flex h-16 items-center text-sm font-medium shadow-[0_14px_34px_rgba(0,0,0,0.18)] backdrop-blur-2xl ${
