  ...
  return (
    <>
      <div className="prose dark:prose-invert container justify-center py-10">
        <h1>Privacy Policy for ЛитКот</h1>

        <p>
          ЛитКот ("we”, “us”, or “our") provides this Privacy Policy to inform you of our policies
          and procedures regarding the collection, use and disclosure of personal information we may
          receive from users of our website (“Site”), accessible from https://leetcot.ru, and any
        ...
        <p>
          ...
          <a href="mailto:support@leetcot.ru">support@leetcot.ru</a>.
        </p>

        <p>
          This Privacy Policy applies only to our online activities and is valid for visitors to our
          website with regards to the information that they shared and/or collect in ЛитКот. This
        ...
        <ul>
          ...
          <li>
            ...
            information relating to the website, and for marketing and promotional purposes(opt
            in).{' '}
          </li>
        ...
        <p>
          ЛитКот follows a standard procedure of using log files. These files log visitors when
        ...
        <p>
          Like any other website, ЛитКот uses "cookies". These cookies are used to store
        ...
        <p>
          ...
          ЛитКот, which are sent directly to users' browser. They automatically receive your IP
        ...
        <p>
          Note that ЛитКот has no access to or control over these cookies that are used by
        ...
        <p>
          ЛитКот's Privacy Policy does not apply to other advertisers or websites. Thus, we are
        ...
        <p>
          ...
          <a href="mailto:leetcot@gmail.com">leetcot@gmail.com</a>.
        </p>
        ...
        <p>
          ЛитКот does not knowingly collect any Personal Identifiable Information from children
        ...
        <p>
          ...
          practices, at <a href="mailto:leetcot@gmail.com">leetcot@gmail.com</a>
        </p>
