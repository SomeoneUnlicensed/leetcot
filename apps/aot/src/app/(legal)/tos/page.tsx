  ...
  return (
    <>
      <div className="prose dark:prose-invert container justify-center py-10">
        ...
        <p>
          By accessing this Website, accessible from https://leetcot.ru, you are agreeing to be
        ...
        <p>
          Permission is granted to temporarily download one copy of the materials on ЛитКот's
        ...
        <ul>
          ...
          <li>attempt to reverse engineer any software contained on ЛитКот's Website;</li>
        ...
        <p>
          This will let ЛитКот to terminate upon violations of any of these restrictions. Upon
        ...
        <p>
          All the materials on ЛитКот's Website are provided "as is". ЛитКот makes no
          warranties, may it be expressed or implied, therefore negates all other warranties.
          Furthermore, ЛитКот does not make any representations concerning the accuracy or
        ...
        <p>
          ЛитКот or its suppliers will not be hold accountable for any damages that will arise
          with the use or inability to use the materials on ЛитКот's Website, even if ЛитКот or
        ...
        <p>
          The materials appearing on ЛитКот's Website may include technical, typographical, or
          photographic errors. ЛитКот will not promise that any of the materials in this Website
          are accurate, complete, or current. ЛитКот may change the materials contained on its
          Website at any time without notice. ЛитКот does not make any commitment to update the
          materials.
        </p>
        ...
        <p>
          ЛитКот has not reviewed all of the sites linked to its Website and is not responsible
          for the contents of any such linked site. The presence of any link does not imply
          endorsement by ЛитКот of the site. The use of any linked website is at the user's own
          risk.
        </p>
        ...
        <p>
          ЛитКот may revise these Terms of Use for its Website at any time without prior notice.
        ...
        <p>
          Any claim related to ЛитКот's Website shall be governed by the laws of af without
