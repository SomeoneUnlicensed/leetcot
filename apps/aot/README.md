...
- [Create a separate github oauth app](https://github.com/settings/applications/new) for aot. Follow the same directions you did for the ЛитКот app. Callback url should be `http://localhost:3003/api/auth/callback/github`
