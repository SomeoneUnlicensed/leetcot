...
const trackChallengeSlugs: Record<string, string[]> = {
  'python-start-cats': [
    'python-fish-hello-cat',
    'python-fish-double-catch',
    'python-fish-square-catch',
    'python-fish-half-catch',
    'python-fish-add-catch',
    'python-fish-abs-catch',
    'python-fish-count-catch',
    'python-fish-sum-catch',
    'python-fish-max-catch',
    'python-fish-min-catch',
    'python-fish-first-catch',
    'python-fish-last-catch',
    'python-fish-sorted-catch',
    'python-fish-positive-catch',
    'python-fish-is-even',
    'python-fish-is-divisible',
    'python-fish-sign-catch',
    'python-fish-cat-greeting',
    'python-fish-cat-upper',
    'python-fish-cat-repeat',
